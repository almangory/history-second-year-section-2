            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-amber-200/90 shadow-sm rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-center justify-between">
                <div className="space-y-2 text-right">
                  ...
                  <p className="text-xs text-slate-700 leading-relaxed font-sans">
                    هل ترغب في السفر عبر الزمان إلى سنار والخرطوم وشندي، أو روما وباريس ولندن وبرلين؟ انقر وتجوّل في معالم الأحداث وحل الاختبارات لتجني نقاطاً إضافية!
                  </p>
                  <button
                    onClick={() => {
                      handlePlaySound("click");
              ...
              <div className="bg-white border border-amber-200/90 shadow-sm rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-center justify-between">
                <div className="space-y-2 text-right">
                  ...
                  <p className="text-xs text-slate-700 leading-relaxed font-sans">
                    سواء كنت تبحث في أحداث حريق شندي 1822م، أو ملحمة إعلان الاستقلال 1956م، أو أسباب الثورة الفرنسية 1789م وبطولات التاريخ العالمي، فإن المعلم الذكي هنا للإجابة عليك فوراً وشرح المنهج بعمق ودقة!
                  </p>
                  <button
                    onClick={() => {
                      handlePlaySound("click");
