...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  {
    id: "gal_turko_egyptian_invasion",
    title: "حملة الغزو التركي المصري وبطولات كورتي وبارا (١٨٢٠ - ١٨٢١م)",
    unitId: 1,
    unitTitle: "الوحدة الأولى: تاريخ السودان الحديث (١٨٢١ - ١٨٨٥م)",
    lessonId: "u1_l1",
    lessonTitle: "الدرس الأول: الغزو التركي المصري للسودان (١٨٢٠ - ١٨٢١م)",
    category: "monument",
    type: "TurkoEgyptianInvasion",
    image: "/assets/lessons/u1_l1.jpg",
    period: "١٨٢٠ - ١٨٢١م (عهد محمد علي باشا)",
    location: "كورتي وشندي وسنار وكردفان",
    description: "مسار حملتي إسماعيل باشا ومحمد بك الدفتردار لغزو السودان عام ١٨٢٠م، وبسالة فرسان الشايقية في معركة كورتي وصمود المقدوم مسلم في بارا دفاعاً عن الوطن والكرامة.",
    historicalDetails: [
      {
        title: "دوافع الغزو ومسار الحملتين",
        description: "تحركت حملة سنار بقيادة إسماعيل باشا بمحاذاة النيل بحثاً عن الذهب والرجال، بينما تحركت حملة كردفان بقيادة الدفتردار غرباً عبر دنقلا والواحات.",
        curriculumFact: "كان بناء جيش حديث قوي والبحث عن مناجم الذهب وتأمين حدود مصر الجنوبية من أهم دوافع الغزو عام ١٨٢٠م."
      },
      {
        title: "صمود كورتي وملحمة المقاومة",
        description: "واجه فرسان الشايقية بالسلاح الأبيض مدافع الغزاة وبنادقهم الحديثة في ملحمة بطولية خالدة خلدتها أشعار مهيرة بت عبود.",
        curriculumFact: "حسم تفوق السلاح الناري والمدافع معركة كورتي لصالح الغزاة رغم استبسال الشايقية النادر."
      }
    ],
    hotspots: [
      { id: "h1", x: 35, y: 55, label: "معسكر جيش الغزو", text: "تمركز قوات إسماعيل باشا المزودة بالمدافع والأسلحة النارية الحديثة." },
      { id: "h2", x: 65, y: 45, label: "فرسان المقاومة الوطنية", text: "فرسان الشايقية واستبسالهم بالشجاعة والسيوف دفاعاً عن أرضهم وحريتهم." },
      { id: "h3", x: 50, y: 80, label: "شريان وادي النيل", text: "المسار الجغرافي الذي سلكته الحملة من وادي حلفا إلى كورتي ثم سنار." }
    ]
  },
  {
