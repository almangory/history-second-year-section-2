...
const SUGGESTIONS = [
  "ما هي أسباب غزو محمد علي باشا للسودان عام 1820م؟",
  "متى تم إعلان استقلال السودان ورفع العلم الوطني؟",
  "ما هي أهم بنود اتفاقية أديس أبابا 1972م للسلام؟",
  "كيف ساهمت مطبعة جوتنبرج في نشر النهضة الأوروبية؟",
  "ما هي نتائج اقتحام سجن الباستيل في الثورة الفرنسية؟",
  "ما هي سياسة الحديد والدم التي اتبعها بسمارك لتوحيد ألمانيا؟",
  "ما هي أسباب اندلاع الحرب العالمية الأولى 1914م؟",
  "متى تأسست هيئة الأمم المتحدة وما هي أهدافها؟"
];
                ...
                <div className="p-4 md:p-5 overflow-y-auto space-y-3.5 flex-1 max-h-[55vh]">
                  ...
                  {searchResults.results.length > 0 ? (
                    ...
                    <div className="text-center py-8 space-y-2 text-[#5c4a38]">
                      ...
                      <p className="text-xs">
                        جرّب البحث بكلمات أبسط مثل: "المك نمر"، "إعلان الاستقلال"، "سد الروصيرص"، "جوتنبرج"، "فرساي".
                      </p>
                    </div>
                  )}
                </div>
